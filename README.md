...
[AliceInCradle](https://fantia.jp/fanclubs/24531/posts) 是由 ひなゆあ 和 橋野みずは 制作的一款轻度 Ryona 类银河恶魔城 ARPG.  
...
编辑器由 zhaouv 的 [antlr-blockly](https://github.com/zhaouv/antlr-blockly) 项目部署得到，图形化部分采用了谷歌 Blockly 的较旧版本（内部状态为 xml 格式），通过 antlr 语法的 .g4 文件定义。
